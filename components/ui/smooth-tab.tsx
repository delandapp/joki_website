      ...
      <div className="relative h-full">
        ...
        <div className="relative flex h-full flex-col p-6">
          <div className="space-y-2">
            <h3 className="from-foreground via-foreground/90 to-foreground/70 bg-gradient-to-r text-2xl font-semibold tracking-tight [text-shadow:_0_1px_1px_rgb(0_0_0_/_10%)]">
              Models
            </h3>
            <p className="max-w-[90%] text-sm leading-relaxed text-black/50 dark:text-white/50">
  ...
  },
  {
    ...
    cardContent: (
      <div className="relative h-full">
        ...
        <div className="relative flex h-full flex-col p-6">
          <div className="space-y-2">
            <h3 className="from-foreground via-foreground/90 to-foreground/70 bg-gradient-to-r text-xl font-semibold tracking-tight [text-shadow:_0_1px_1px_rgb(0_0_0_/_10%)]">
              MCPs
            </h3>
            <p className="max-w-[90%] text-sm leading-relaxed text-black/50 dark:text-white/50">
  ...
  return (
    <div className="flex h-full flex-col">
      ...
      <div className="relative mb-4 flex-1">
        <div className="bg-card relative h-[200px] w-full rounded-lg border">
