...
function NavigationMenuList({
  ...
  return (
    <NavigationMenuPrimitive.List
      ...
      className={cn(
        // GANTI 'group' default → group/navlist supaya tidak membocorkan hover ke anak-anak
        "group/navlist flex flex-1 list-none items-center justify-center gap-1",
        className,
      )}
      {...props}
    />
  ...
  return (
    <NavigationMenuPrimitive.Content
      ...
      className={cn(
        ...
        // posisikan center terhadap trigger (sudah dari jawaban sebelumnya)
