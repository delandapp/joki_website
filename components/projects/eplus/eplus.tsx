...
const EPLUS_PROJECT_CARD: CardShiftProjectProps = {
  title: "E-Plus",
  description:
  ...
  image: {
    src: "/assets/images/projects/eplus/poster.svg",
...
const EplusProject = () => (
  <CardShiftProject {...EPLUS_PROJECT_CARD} className="flex justify-center" />
);

export default EplusProject;
