...
const STEMDU_PROJECT_CARD: CardShiftProjectProps = {
  title: "Video Riset",
  description:
  ...
  image: {
    src: "/assets/images/projects/video-riset/poster.svg",
...
const VideoRisetProject = () => (
  <CardShiftProject {...STEMDU_PROJECT_CARD} className="flex justify-center" />
);

export default VideoRisetProject;
