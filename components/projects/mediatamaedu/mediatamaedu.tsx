...
const MEDIATAMAEDU_PROJECT_CARD: CardShiftProjectProps = {
  title: "Mediatama Edu",
  description:
  ...
  image: {
    src: "/assets/images/projects/mediatamaedu/poster.svg",
...
const MediatamaEduProject = () => (
  <CardShiftProject
    {...MEDIATAMAEDU_PROJECT_CARD}
    className="flex justify-center"
  />
);

export default MediatamaEduProject;
